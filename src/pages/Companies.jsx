...
function CompanyForm({ item, onSave, onCancel }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div><Label className="text-xs text-muted-foreground">Tax ID / TRN</Label><Input value={f.tax_id} onChange={e => set('tax_id', e.target.value)} className="bg-secondary border-border font-mono" /></div>
