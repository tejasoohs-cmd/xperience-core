        ...
        <table className="w-full text-sm mb-6">
          <thead>
            <tr className="border-b-2 border-gray-300">
              ...
              <th className="py-2 text-left text-xs font-medium text-gray-500 hidden md:table-cell">Passenger / Booker</th>
              <th className="py-2 text-left text-xs font-medium text-gray-500 hidden lg:table-cell">Vehicle / Driver</th>
              <th className="py-2 text-left text-xs font-medium text-gray-500 hidden lg:table-cell">Ref / Route</th>
            ...
            {invBookings.map(b => {
              ...
              return (
                <tr key={b.id} className="border-b border-gray-200">
                  ...
                  <td className="py-2 hidden md:table-cell">{b.primary_passenger_name}<br /><span className="text-xs text-gray-500">{b.booker_name}</span></td>
                  <td className="py-2 hidden lg:table-cell">{vt?.name || '—'}<br /><span className="text-xs text-gray-500">{driver?.name || '—'}</span></td>
                  <td className="py-2 hidden lg:table-cell text-xs">{b.po_client_ref || '—'}<br /><span className="text-gray-500">{b.pickup_location} → {b.dropoff_location}</span></td>
